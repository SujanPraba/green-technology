...
const CondentLeft = () => {
  ...
  return (
    <div className="flex  lg:w-[90%] lg:rounded-tr-[200px] lg:rounded-br-[200px] bg-gradient-to-r from-[#D5A142] via-[#A59F78] to-[#C0CDCB]">
      ...
      <div className="md:w-[50%] w-[90%] mx-auto flex md:justify-start justify-center lg:ml-2 py-[30px]">
        ...
        <div>
          {/* <Image src={leftImage} alt="img" className="pl-[55px] mt-[25px] h-[300px]" /> */}
        </div>
      </div>
    </div>
  );
