...
import rightImage from "../../public/content/rightImage.png";
...
const CondentRight = () => {
    ...
    return (
        <div className="flex lg:w-[90%] ml-auto lg:rounded-tl-[200px] lg:rounded-bl-[200px] bg-gradient-to-r from-[#F2E3C6] via-[#9C9D7C] to-[#1F473E]" ref={ref}>
            ...
            <div className="md:w-[40%] lg:w-[50%] hidden md:flex items-end mx-auto">
                <Image src={rightImage} alt="img" className="pl-[55px] mt-[60px] hidden md:flex" />
            </div>
        </div>
    );
};
